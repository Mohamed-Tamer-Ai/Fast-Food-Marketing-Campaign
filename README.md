...
### 🌐 1. View the Streamlit Dashboard (Python)
**Live App:** [https://fast-food-marketing-campaign-punirphtjmzbxzosfq9d4w.streamlit.app/](https://fast-food-marketing-campaign-punirphtjmzbxzosfq9d4w.streamlit.app/)

To run the interactive web app locally instead:
